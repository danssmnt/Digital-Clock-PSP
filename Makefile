TARGET = DigitalClock
OBJS = src/utils.o src/error.o src/battery.o src/callbacks.o lib/glib2d/glib2d.o src/tex.o src/main.o

LIBS = -lpng -lz -lpspgu -lm -lpspvram -lpsprtc -lpspctrl -lpsppower
